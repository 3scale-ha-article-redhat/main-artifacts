...
scp -r ../redis/config/master/* ec2-user@[redis-master-host]:'~/sentinel/master/'
...
scp -r ../redis/config/replica1/* ec2-user@[redis-replica-host-1]:'~/sentinel/replica/'
...
scp -r ../redis/config/replica2/* ec2-user@[redis-replica-host-2]:'~/sentinel/replica/'
